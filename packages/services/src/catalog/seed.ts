...
export const SEED_MARKETS: Market[] = [
  ...
  // ── Policy (IDs 10-12) ────────────────────────────────────────────────
  {
    ...
    category: "policy",
    legs: [
      { id: 10, question: "Will a US stablecoin bill pass by June 2026?", sourceRef: "congress-gov", cutoffTime: 1751328000, earliestResolve: 1751414400, probabilityPPM: 400000, active: true },
      { id: 11, question: "Will the SEC approve a spot SOL ETF by Q3 2026?", sourceRef: "sec-filings", cutoffTime: 1759276800, earliestResolve: 1759363200, probabilityPPM: 250000, active: true },
      { id: 12, question: "Will the US create a strategic Bitcoin reserve?", sourceRef: "executive-orders", cutoffTime: 1751328000, earliestResolve: 1751414400, probabilityPPM: 150000, active: true },
    ],
  },
  // ── Economics (IDs 13-15) ─────────────────────────────────────────────
  {
    ...
    legs: [
      ...
      { id: 14, question: "Will S&P 500 hit 7000 by end of 2026?", sourceRef: "yahoo-finance", cutoffTime: 1767139200, earliestResolve: 1767225600, probabilityPPM: 350000, active: true },
      { id: 15, question: "Will global crypto market cap exceed $5T?", sourceRef: "coingecko", cutoffTime: 1767139200, earliestResolve: 1767225600, probabilityPPM: 300000, active: true },
    ],
  },
  // ── Trivia (IDs 16-18) ────────────────────────────────────────────────
  {
    ...
    category: "trivia",
    legs: [
      { id: 16, question: "Will a memecoin enter the top 10 by market cap?", sourceRef: "coingecko", cutoffTime: 1751328000, earliestResolve: 1751414400, probabilityPPM: 200000, active: true },
      { id: 17, question: "Will Elon Musk tweet about Dogecoin this week?", sourceRef: "twitter-api", cutoffTime: 1740000000, earliestResolve: 1740100000, probabilityPPM: 700000, active: true },
      { id: 18, question: "Will a crypto project raise $1B+ in a single round?", sourceRef: "crunchbase", cutoffTime: 1751328000, earliestResolve: 1751414400, probabilityPPM: 150000, active: true },
    ],
  },
  // ── ETHDenver (IDs 19-21) ─────────────────────────────────────────────
  {
    ...
    category: "ethdenver",
    legs: [
      { id: 19, question: "Will over 20,000 people attend ETHDenver?", sourceRef: "ethdenver-org", cutoffTime: 1740700000, earliestResolve: 1740800000, probabilityPPM: 600000, active: true },
      { id: 20, question: "Will a hackathon project get acquired within 30 days?", sourceRef: "twitter-api", cutoffTime: 1743379200, earliestResolve: 1743465600, probabilityPPM: 100000, active: true },
      { id: 21, question: "Will ParlayCity win a bounty at ETHDenver?", sourceRef: "ethdenver-org", cutoffTime: 1740700000, earliestResolve: 1740800000, probabilityPPM: 750000, active: true },
    ],
  },
];
