...
USDC amounts are in 6-decimal format on-chain but display as human-readable dollars.`,
    ...
    tools: {
      list_markets: tool({
        description:
          "List available betting markets. Optionally filter by category (crypto, defi, nft, policy, economics, trivia, ethdenver, nba). NBA markets are live from BallDontLie.",
        parameters: z.object({
          category: z
            .string()
            .optional()
